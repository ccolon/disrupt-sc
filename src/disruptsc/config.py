...
def build_params(config: dict) -> tuple[TransportParams, SimParams, AgentParams, LogisticsParams]:
    ...
    logistics_params = LogisticsParams(
        ...
        nb_cost_profiles=logistics.get("nb_cost_profiles", 1),
        basic_cost_random=logistics.get("basic_cost_random", False),
        basic_cost_variability=logistics.get("basic_cost_variability", {}),
