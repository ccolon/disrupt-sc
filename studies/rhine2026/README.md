...
floors runs; regenerate from the pooled runs at paper time). Results (10 Sep): 2026 on the forecast-based 19-week profile (`2026_seed42_pool_fc0910`) DEU 8.57 bn USD
(0.90 % of a quarter, peak 1.38 % of a week after the last tank-barge closure in mid-October; 3.55 bn = 0.37 %
on the observed-to-4-Sep profile), 2018 5.57 bn (0.58 %, peak 1.23 % of a week in the first week of December); delivered prices up to +13 % in surcharge weeks and +29 % in a closure week (v13
