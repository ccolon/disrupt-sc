...
floors runs; regenerate from the pooled runs at paper time). Results (10 Sep): DEU 3.55 bn USD (0.37 % of a
quarter, peak 0.99 % of a week in the 11 cm week) in 2026, 5.57 bn (0.58 %, peak 1.23 % of a week in the first
week of December) in 2018; delivered prices up to +13 % in surcharge weeks and +29 % in a closure week (v13
...
| **forecast-based 2026 rerun (10 Sep, user decisions: pooled baseline confirmed, rerun now)** — queue v16, launched 10 Sep 09:28 | `run_rhine.py --profile 2026 --no-open --seed 42 --recovery-weeks 20 --light-export` on the refreshed profile (`fetch_kaub.py`: observations to 10 Sep, the BfG 6-week ENS medians of 7 Sep for 14 Sep–18 Oct, 85/105 cm assumptions for 19/26 Oct; 19 weeks; every class closed at steps 6–9 and 12–14, tank barges at 15–16, surcharge only at 17–19) → `2026_seed42_pool_fc0910`; watcher v8 | running, 40 steps ≈ 7 h → ≈ 17:00. Expected: the German loss roughly doubles the 3.55 bn of the observed-plus-assumptions profile (three more full-closure weeks and a tank-barge tail). Refresh again when observations replace the forecast weeks; the run name carries the forecast vintage |
