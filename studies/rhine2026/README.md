...
| **sensitivity grid of the adopted baseline** (queue v12, 06 Sep 05:10, laptop, light exports: `--light-export` skips the 7 GB of link/inventory files) | closure floors: tanker floor 40 cm (`…_floors_liq40`), all floors +10 cm (`…_floors_p10`: 50/60/40) and −10 cm (`…_floors_m10`: 30/40/20), for 2018 and 2026; floors plus the sector-specific give-up thresholds of `additional_data/giveup_thresholds_by_sector.yaml` as the upper-bound reading (`…_floors_thr`), for 2018 and 2026 — 8 runs, ≈ 30 h sequential; order: 2018 liq40, 2018 p10, 2026 p10, 2026 m10, 2018 m10, 2026 liq40, 2018 thr, 2026 thr | running; `compare_runs.py` on the run folders when done |
