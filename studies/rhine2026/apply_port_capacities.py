...
(default on: the within-step capacity gate rations the saturated terminals
and re-sends the cut shares through other ports; 21 Sep 2026, replaces the
former binary mode).

Usage:
    python studies/rhine2026/apply_port_capacities.py [--mode on|off] [--config <path>]
"""
...
def main():
    ...
    lines = [BEGIN,
             ...
             f"capacity_constraint: {'true' if args.mode == 'on' else 'false'}",
